          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
            ...
            <div className="space-y-4">
              ...
              <p className="text-gray-400 text-sm leading-relaxed">
                Explore the timeless world of GOHIGGLER PRIVATE LIMITED - your
                gateway to eternal experiences and innovations.
              </p>
            </div>

            {/* Quick Links */}
            <div>
              <h3 className="text-white font-semibold text-base mb-4 font-be-vietnam-pro">
                Quick Links
              </h3>
        ...
        <div className="border-t border-white/10 py-6">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-gray-400 text-sm text-center md:text-left">
              &copy; {new Date().getFullYear()} GOHIGGLER PRIVATE LIMITED. All
              rights reserved.
            </p>
